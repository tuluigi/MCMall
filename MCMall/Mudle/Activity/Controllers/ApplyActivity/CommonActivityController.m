...
-(void)getVoteAcitivityWithActivityID:(NSString *)activityID{
    ...
    [[HHNetWorkEngine sharedHHNetWorkEngine]  getActivityDetailWithActivityID:activityID activityType:ActivityTypeCommon userID:[UserModel userID] onCompletionHandler:^(HHResponseResult *responseResult) {
