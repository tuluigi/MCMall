...
-(void)setGoodsModel:(GoodsModel *)goodsModel{
    ...
    NSAttributedString *priceAttrStr=[NSString attributedStringWithOrignalPrice:_goodsModel.marketPrice orignalFontSize:12 newPrice:_goodsModel.sellPrice newFontSize:16];
